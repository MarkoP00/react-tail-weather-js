...
const App = () => {
  ...
  const handleRetry = () => {
    if (currentWeather) {
      return fetchWeatherByCity(currentWeather.name);
    }
    fetchWeatherByCity("Belgrade");
  };

  return (
    <div className="relative overflow-hidden min-h-screen bg-blue-200">
      {/* background  */}
      <div
          ...
          <div className="text-center mb-12">
            <div className="mb-8">
              ...
              <p className="text-white/80 text-lg md:text-xl mb-8 max-w-2xl mx-auto leading-relaxed">
                ...
                beautiful visuals, and percise forecasts for any location
                worldwide!
              </p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center space-y-6 lg:space-y-0 lg:space-x-6 mb-12 ">
              <SearchBar
                ...
                onLoactionSearch={fetchWeatherByLocation}
                loading={loading}
              />
